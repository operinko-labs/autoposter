...
verification + 86 implementation). Rows 104 and 105 are not inventory rows: they were
added by phase 5b's verification sweep as the scoped follow-ups to rows 5 and 4. One row changed disposition after the inventories
